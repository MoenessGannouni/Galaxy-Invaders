<?php
    ...
    //$categorieU = new categorieC();
    //$categorieD = new categorieC();
    if (
        ...
        isset($_POST["Category_Pr"]) 
            ...
            $categorieC->ajoutercategorie($categorieM);  
            //$categorieU->modifiercategorie($categorieM, $_POST["ID"]);
            header('Location:categories.php');
            //$categorieD->supprimercategorie($_POST["id_ct"]);
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="notification-user">Rania</h5>
                                ...
                                <div class="">
                                    <div class="main-menu-header">
                                        ...
                                        <div class="user-details">
                                            <span id="more-details">Rania<i class="fa fa-caret-down"></i></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Purchases - categories</h5>
                                        ...
                                        <div class="col-md-4">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Purchases - categories</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="page-body">
                                            <div class="row">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-sm">
                                                        <button class="add_btn open_btn" onclick="addcategorie()" data-toggle="form_popup" data-target="#myform" id="add_categorie">+ Add categorie</button>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="form_popup" id="myform">
                                                    <form action="" class="form_container" method="POST">
                                                        <h1>Add categorie</h1>
                                                        <input type="hidden"placeholder="Enter Name" id="id_ct" name="id_ct">

                                                       

                                                        <input class="champs" onblur="saisirCategory()" type="text" placeholder="Enter categorie Category" id="Category_Pr" name="Category_Pr">
                                                        <p id="errorCategory" class="error"></p>


                                                        <button type="submit" class="add_btn" onclick="ajoutcategorie(event)">Submit</button>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="data-table-main icon-list-demo">
                                                            <div class="row">
                                                                <table id="categorie_table" border="1">
                                                                    <tr>
                                                                        <td>categorie ID</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $categorie['id_ct']; ?>
                                                                        </td>
                                                                        
                                                                        <td>
                                                                            <?php echo $categorie['Category_Pr']; ?>
                                                                        </td>
                                                                       
                                                                        <td>
                                                                            <form action="update categories.php" method="POST">
                                                                                <input type="submit" class="add_btn" value="Edit">
                                                                                <input type="hidden" value=<?PHP echo $categorie['id_ct']; ?> name="id_ct">
                                                                            </form>
                                                                        </td>
                                                                        <td>
                                                                        <form action="delete categories.php" method="POST">
